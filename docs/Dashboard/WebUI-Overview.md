...
:::info 🔐 Login Rate Limits
The WebUI implements rate limits to protect against brute-force attacks. For detailed configuration, see [API Rate Limits](/docs/API/Rate-Limits#login-rate-limits).
:::
